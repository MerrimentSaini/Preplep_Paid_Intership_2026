...
#1). Sort students by marks using lambda function..!
#Students = {'AviSaini':55,'Mayank Prajapati':77,'Harsh Shah':54,'Mradul Saxena':62,'Vaibhav Arya':64}
#sorted_students = sorted(Students.items(), key = lambda x:x[1])
#print("\nStudents sorted based on their marks: \n",sorted_students)

#2). Filter active users using lambda function..!
# users = [
#          {"name" : "AviSaini", "active" : True},
#          {"name" : "HarshShah","active" : False},
#          {"name" : "Mayank", "active": True}
# ]
#
# active_users = list(
#     filter(lambda user: user["active"]==True, users)
# )
# print(active_users)
#
#
